...
Radiology: Artificial Intelligence asks that supplemental material "should be limited to 12
pages", and twenty one-per-page figures cannot meet that. Nothing is dropped: every panel of every
...
own (A)/(B) labels -- so the merged legends in build_docx.js identify parts by position instead.
