...
| File | Purpose |
|------|---------|
| `ANALYSES.md`                       | Every analysis behind a reported number: command, inputs, outputs, result |
| `FILE_STRUCTURE.md`                 | This file |
| `PIPELINE_OUTPUTS.md`               | Every input/output per step |
| `domain_shift_external_protocol.md` | Protocol for the external feature-transfer analysis (step 18) |
